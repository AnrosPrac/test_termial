...
from app.admin.hardened_firebase_auth import (
    ...
    verify_admin_jwt,
    create_admin_jwt,
    verify_credentials  # ✅ Changed from verify_firebase_token
)
...
# ✅ FIXED: Changed from firebase_token to username/password
...
async def admin_login(payload: AdminLoginRequest):
    ...
    Accepts username/password and returns admin JWT.
    """
